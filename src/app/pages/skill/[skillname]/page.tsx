...
function displayCompletedIcon(completed: boolean, explanation: string) {
  if (completed) {
    return (
      <svg
        width='15'
  ...
  if (!completed && explanation != undefined && explanation !== "") {
    return (
      <svg
        width='15'
        height='15'
...
function accordionContent(completed: boolean, explanation: string) {}
